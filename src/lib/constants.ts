...
export const PROJECTS: Project[] = [
  ...
  {
    id: "fire-suppression",
    title: "Intelligent Fire Suppression System",
    description:
      "Real-time fire detection pipeline using computer vision with AI-driven robotic arm control.",
    details: [
      "Real-time fire detection pipeline using computer vision models.",
      "Object-aware decision system to select suppression agents dynamically.",
      "AI inference integrated with robotic arm control.",
      "Improved system accuracy and response reliability through model tuning and structured pipeline design.",
    ],
    techStack: ["Computer Vision", "AI/ML", "Python", "Robotics"],
    outcome: "Enhanced detection accuracy",
